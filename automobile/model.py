...
def predict(inp):
    ...
    workspace_id, service_id, api_key = key_data['workspace_id'], key_data['service_id'], key_data['ml_api_key']
    url = 'https://ussouthcentral.services.azureml.net/workspaces/{}/services/{}/execute?api-version=2.0&details=true'.format(workspace_id, service_id)
